...
public class CoursesRvAdapter extends RecyclerView.Adapter<CoursesRvAdapter.CoursesVH> {
    ...
    private ArrayList<CourseApus> courseResult;

    public CoursesRvAdapter(ArrayList<CourseApus> myDataset) {
       ...
       Picasso.with(context).
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String courseCategory = courseResult.get(position).getCategoryName();
