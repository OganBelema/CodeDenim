...
public class OthersRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton = findViewById(R.id.other_register_button);
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(MyUtilClass.INSTANCE.checkNetworkConnection(getApplicationContext())){
                    ...
                    MyUtilClass.INSTANCE.showNoInternetMessage(OthersRegisterActivity.this);
                }
            }
        });
    ...
    private void attemptRegister() {
        ...
        if (cancel) {
            ...
            showProgress();
            register(new User(firstname, lastName, gender, dateOfBirth, phoneNumber,
                    email, password, confirmPassword));
        }
    }

    private void register(User student){
        ServiceGenerator.INSTANCE.getApiMethods()
                .registerOtherStudent(student).enqueue(new Callback<ResponseBody>() {
            @Override
