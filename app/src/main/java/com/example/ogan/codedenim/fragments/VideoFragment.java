...
public class VideoFragment extends Fragment {
    ...
    final String videoURL = "https://codedenim.azurewebsites.net/MaterialUpload/Data Management_ What Is Master Data Management (Mdm).mp4";
    View v;
    ...
    private void initializePlayer() {
        ...
        simpleExoPlayerView =  v.findViewById(R.id.videoView);
